...
# # test: 
# model.predict(Data2Model.iloc[1:100,:].loc[:,X_list])
# model2.predict(Data2Model.iloc[1:100,:].loc[:,X_list])

# Save the inspector using pickle
with open(Path_to_Save_Results+'/inspector.pkl', 'wb') as file:
    pickle.dump(inspector, file)
# # Load the inspector
# with open(Path_to_Save_Results+'/inspector.pkl', 'rb') as file:
#     inspector2 = pickle.load(file)
...
# # Load scores
# with open(Path_to_Save_Results+'/scores.pkl', 'rb') as file:
